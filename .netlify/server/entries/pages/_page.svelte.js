...
const css$3 = {
  code: "header.svelte-19rkq4s{width:100%;padding:10px 0;position:sticky;top:0;z-index:9999;background:var(--background-color);box-shadow:0 4px 4px #0004}nav.svelte-19rkq4s{width:100%;max-width:1100px;margin:0 auto;padding:0 20px;display:flex;justify-content:space-between;align-items:center}ul.svelte-19rkq4s{display:flex;gap:20px}li.svelte-19rkq4s{width:fit-content;height:40px;display:flex;align-items:center;overflow:hidden}a.svelte-19rkq4s{position:relative}a.svelte-19rkq4s::before{content:'';width:100%;height:2px;position:absolute;bottom:-2px;left:-90%;background-color:rgba(var(--pry-color-rgb), 0.4);transition:0.8s}a.svelte-19rkq4s:hover::before{left:90%}a.active.svelte-19rkq4s::before{left:0%;transition:0.2;background-color:rgba(var(--pry-color-rgb), 1)}.languages.svelte-19rkq4s{display:flex;gap:10px}button.svelte-19rkq4s{padding:0 4px;font-size:30px;border:none;background-color:transparent;display:flex;align-items:center}button.active.svelte-19rkq4s{outline:2px solid rgba(var(--pry-color-rgb), 0.4);border-radius:8px}",
  map: `{"version":3,"file":"Header.svelte","sources":["Header.svelte"],"sourcesContent":["<script>\\r\\n    import Icon from \\"@iconify/svelte\\";\\r\\n    import { page } from \\"$app/stores\\";\\r\\n    import { language, dataLang } from '../store/store'\\r\\n    import { data } from '$lib/data.js';\\r\\n    import { browser } from \\"$app/environment\\";\\r\\n\\r\\n    let idioma = 'es'\\r\\n\\r\\n    $: $language = idioma\\r\\n    $: $dataLang = data.find((item) => item.lang === $language).data;\\r\\n    \\r\\n    const handleLang = (lang) => {\\r\\n        idioma = lang\\r\\n    }\\r\\n\\r\\n    if (browser) {\\r\\n        idioma = window.localStorage.getItem(\\"languageSite\\") || \\"es\\";\\r\\n        handleLang(idioma)\\r\\n    }\\r\\n\\r\\n    $: if (browser) {\\r\\n        window.localStorage.setItem(\\"languageSite\\", $language);\\r\\n    }\\r\\n    \\r\\n    $: liActive = $page.url.hash.substring(1) || 'about';\\r\\n\\r\\n    export const handleLi = (listItem) => {\\r\\n        liActive = listItem\\r\\n    }\\r\\n\\r\\n<\/script>\\r\\n\\r\\n<header>\\r\\n    <nav>\\r\\n        <div class=\\"languages\\">\\r\\n            <button on:click={ () => handleLang('en') } class={ idioma === 'en' ? 'active' : '' }>\\r\\n                <Icon icon=\\"twemoji:flag-united-states\\" />\\r\\n            </button>\\r\\n            <button on:click={ () => handleLang('es') } class={ idioma === 'es' ? 'active' : '' }>\\r\\n                <Icon icon=\\"twemoji:flag-argentina\\" />\\r\\n            </button>\\r\\n        </div>\\r\\n    \\r\\n        <ul>\\r\\n            <li>\\r\\n                <a on:click={ () => handleLi('about') } class={ liActive === 'about' ? 'active' : '' } href=\\"#about\\">\\r\\n                    {$dataLang.header[0]}\\r\\n                </a>\\r\\n            </li>\\r\\n            <li>\\r\\n                <a on:click={ () => handleLi('skills') } class={ liActive === 'skills' ? 'active' : '' } href=\\"#skills\\">\\r\\n                    {$dataLang.header[1]}\\r\\n                </a>\\r\\n            </li>\\r\\n            <li>\\r\\n                <a on:click={ () => handleLi('projects') } class={ liActive === 'projects' ? 'active' : '' } href=\\"#projects\\">\\r\\n                    {$dataLang.header[2]}\\r\\n                </a>\\r\\n            </li>\\r\\n            <li>\\r\\n                <a on:click={ () => handleLi('experience') } class={ liActive === 'experience' ? 'active' : '' } href=\\"#experience\\">\\r\\n                    {$dataLang.header[3]}\\r\\n                </a>\\r\\n            </li>\\r\\n            <li>\\r\\n                <a on:click={ () => handleLi('contact') } class={ liActive === 'contact' ? 'active' : '' } href=\\"#contact\\">\\r\\n                    {$dataLang.header[4]}\\r\\n                </a>\\r\\n            </li>\\r\\n        </ul>\\r\\n    </nav>\\r\\n</header>\\r\\n\\r\\n<style>\\r\\n    header {\\r\\n        width: 100%;\\r\\n        padding: 10px 0;\\r\\n        position: sticky;\\r\\n        top: 0;\\r\\n        z-index: 9999;\\r\\n        background: var(--background-color);\\r\\n        box-shadow: 0 4px 4px #0004;\\r\\n    }\\r\\n    \\r\\n    nav {\\r\\n        width: 100%;\\r\\n        max-width: 1100px;\\r\\n        margin: 0 auto;\\r\\n        padding: 0 20px;\\r\\n        display: flex;\\r\\n        justify-content: space-between;\\r\\n        align-items: center;\\r\\n    }\\r\\n\\r\\n    ul {\\r\\n        display: flex;\\r\\n        gap: 20px;\\r\\n    }\\r\\n\\r\\n    li {\\r\\n        width: fit-content;\\r\\n        height: 40px;\\r\\n        display: flex;\\r\\n        align-items: center;\\r\\n        overflow: hidden;\\r\\n    }\\r\\n\\r\\n    a {\\r\\n        position: relative;\\r\\n    }\\r\\n    \\r\\n    a::before {\\r\\n        content: '';\\r\\n        width: 100%;\\r\\n        height: 2px;\\r\\n        position: absolute;\\r\\n        bottom: -2px;\\r\\n        left: -90%;\\r\\n        background-color: rgba(var(--pry-color-rgb), 0.4);\\r\\n        transition: 0.8s;\\r\\n    }\\r\\n\\r\\n    a:hover::before {\\r\\n        left: 90%;\\r\\n    }\\r\\n\\r\\n    a.active::before {\\r\\n        left: 0%;\\r\\n        transition: 0.2;\\r\\n        background-color: rgba(var(--pry-color-rgb), 1);\\r\\n    }\\r\\n\\r\\n    .languages {\\r\\n        display: flex;\\r\\n        gap: 10px;\\r\\n    }\\r\\n\\r\\n    button {\\r\\n        padding: 0 4px;\\r\\n        font-size: 30px;\\r\\n        border: none;\\r\\n        background-color: transparent;\\r\\n        display: flex;\\r\\n        align-items: center;\\r\\n    }\\r\\n\\r\\n    button.active {\\r\\n        outline: 2px solid rgba(var(--pry-color-rgb), 0.4);\\r\\n        border-radius: 8px;\\r\\n    }\\r\\n</style>"],"names":[],"mappings":"AA2EI,qBAAO,CACH,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CAAC,CAAC,CACf,QAAQ,CAAE,MAAM,CAChB,GAAG,CAAE,CAAC,CACN,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,IAAI,kBAAkB,CAAC,CACnC,UAAU,CAAE,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,KAC1B,CAEA,kBAAI,CACA,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,OAAO,CAAE,CAAC,CAAC,IAAI,CACf,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MACjB,CAEA,iBAAG,CACC,OAAO,CAAE,IAAI,CACb,GAAG,CAAE,IACT,CAEA,iBAAG,CACC,KAAK,CAAE,WAAW,CAClB,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,QAAQ,CAAE,MACd,CAEA,gBAAE,CACE,QAAQ,CAAE,QACd,CAEA,gBAAC,QAAS,CACN,OAAO,CAAE,EAAE,CACX,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CACX,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,IAAI,CAAE,IAAI,CACV,gBAAgB,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,GAAG,CAAC,CACjD,UAAU,CAAE,IAChB,CAEA,gBAAC,MAAM,QAAS,CACZ,IAAI,CAAE,GACV,CAEA,CAAC,sBAAO,QAAS,CACb,IAAI,CAAE,EAAE,CACR,UAAU,CAAE,GAAG,CACf,gBAAgB,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,CAClD,CAEA,yBAAW,CACP,OAAO,CAAE,IAAI,CACb,GAAG,CAAE,IACT,CAEA,qBAAO,CACH,OAAO,CAAE,CAAC,CAAC,GAAG,CACd,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,IAAI,CACZ,gBAAgB,CAAE,WAAW,CAC7B,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MACjB,CAEA,MAAM,sBAAQ,CACV,OAAO,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,GAAG,CAAC,CAClD,aAAa,CAAE,GACnB"}`
};
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_language();
  $$unsubscribe_dataLang();
  return `<header class="svelte-19rkq4s"><nav class="svelte-19rkq4s"><div class="languages svelte-19rkq4s"><button class="${escape(null_to_empty(""), true) + " svelte-19rkq4s"}">${validate_component(Icon, "Icon").$$render($$result, { icon: "twemoji:flag-united-states" }, {}, {})}</button> <button class="${escape(null_to_empty("active"), true) + " svelte-19rkq4s"}">${validate_component(Icon, "Icon").$$render($$result, { icon: "twemoji:flag-argentina" }, {}, {})}</button></div> <ul class="svelte-19rkq4s"><li class="svelte-19rkq4s"><a class="${escape(null_to_empty(liActive === "about" ? "active" : ""), true) + " svelte-19rkq4s"}" href="#about">${escape($dataLang.header[0])}</a></li> <li class="svelte-19rkq4s"><a class="${escape(null_to_empty(liActive === "skills" ? "active" : ""), true) + " svelte-19rkq4s"}" href="#skills">${escape($dataLang.header[1])}</a></li> <li class="svelte-19rkq4s"><a class="${escape(null_to_empty(liActive === "projects" ? "active" : ""), true) + " svelte-19rkq4s"}" href="#projects">${escape($dataLang.header[2])}</a></li> <li class="svelte-19rkq4s"><a class="${escape(null_to_empty(liActive === "experience" ? "active" : ""), true) + " svelte-19rkq4s"}" href="#experience">${escape($dataLang.header[3])}</a></li> <li class="svelte-19rkq4s"><a class="${escape(null_to_empty(liActive === "contact" ? "active" : ""), true) + " svelte-19rkq4s"}" href="#contact">${escape($dataLang.header[4])}</a></li></ul></nav> </header>`;
});
const css$2 = {
  code: ".section_wrapper.svelte-13bqemh.svelte-13bqemh{min-height:calc(100vh - 60px);width:100%;display:flex;flex-direction:column;justify-content:center;position:relative}h1.svelte-13bqemh.svelte-13bqemh,h2.svelte-13bqemh.svelte-13bqemh,h3.svelte-13bqemh.svelte-13bqemh{line-height:1;margin-top:-5px}h2.svelte-13bqemh.svelte-13bqemh{font-size:60px}h1.svelte-13bqemh.svelte-13bqemh{letter-spacing:12px;word-spacing:2px}.about_me.svelte-13bqemh.svelte-13bqemh{width:90%;padding:20px 0;display:flex;flex-direction:column;gap:10px}.going_down.svelte-13bqemh.svelte-13bqemh{width:100%;position:absolute;bottom:20px;display:flex;justify-content:center}.going_down.svelte-13bqemh a.svelte-13bqemh{width:fit-content;display:flex;flex-direction:column;align-items:center}.going_down.svelte-13bqemh svg.svelte-13bqemh{font-size:30px;margin-top:-20px;transform:scaleX(1.2);opacity:0.8}.buttons.svelte-13bqemh.svelte-13bqemh{display:flex;align-items:center;gap:20px}.buttons.svelte-13bqemh button.svelte-13bqemh{background:var(--pry-color);border:2px solid var(--pry-color);border-radius:8px;padding:10px 15px}.buttons.svelte-13bqemh a.svelte-13bqemh{color:var(--pry-color);border:2px solid var(--pry-color);border-radius:8px;padding:10px 15px;font-size:14px}",
  map: `{"version":3,"file":"Hero.svelte","sources":["Hero.svelte"],"sourcesContent":["<script>\\r\\n    import { language, dataLang } from '../store/store'\\r\\n    import { data } from '$lib/data.js';\\r\\n\\r\\n    $: $dataLang = data.find((item) => item.lang === $language).data;\\r\\n<\/script>\\r\\n\\r\\n<section class=\\"section_wrapper\\" id=\\"about\\">\\r\\n    <h3>{$dataLang.hero.h3}</h3>\\r\\n\\r\\n    <h2>{$dataLang.hero.h2}</h2>\\r\\n    \\r\\n    <h1>{$dataLang.hero.h1}</h1>\\r\\n\\r\\n    <div class=\\"about_me\\">\\r\\n        <p>{$dataLang.hero.paragraph[0]}</p>\\r\\n        <p>{$dataLang.hero.paragraph[1]}</p>\\r\\n        <p>{$dataLang.hero.paragraph[2]}</p>\\r\\n        <p>{$dataLang.hero.paragraph[3]}</p>\\r\\n    </div>\\r\\n\\r\\n    <div class=\\"going_down\\">\\r\\n        <a href=\\"#skills\\">\\r\\n            <svg xmlns=\\"http://www.w3.org/2000/svg\\" width=\\"1em\\" height=\\"1em\\" viewBox=\\"0 0 24 24\\"><path fill=\\"currentColor\\" fill-rule=\\"evenodd\\" d=\\"m6 7l6 6l6-6l2 2l-8 8l-8-8z\\"/></svg>\\r\\n\\r\\n            <svg xmlns=\\"http://www.w3.org/2000/svg\\" width=\\"1em\\" height=\\"1em\\" viewBox=\\"0 0 24 24\\"><path fill=\\"currentColor\\" fill-rule=\\"evenodd\\" d=\\"m6 7l6 6l6-6l2 2l-8 8l-8-8z\\"/></svg>\\r\\n        </a>\\r\\n    </div>\\r\\n\\r\\n    <div class=\\"buttons\\">\\r\\n        <button>{$dataLang.hero.buttons[0]}</button>\\r\\n        <a href=\\"#contact\\">{$dataLang.hero.buttons[1]}</a>\\r\\n    </div>\\r\\n</section>\\r\\n\\r\\n<style>\\r\\n    .section_wrapper {\\r\\n        min-height: calc(100vh - 60px);\\r\\n        width: 100%;\\r\\n        display: flex;\\r\\n        flex-direction: column;\\r\\n        justify-content: center;\\r\\n        position: relative;\\r\\n    }\\r\\n\\r\\n    h1, h2, h3 {\\r\\n        line-height: 1;\\r\\n        margin-top: -5px;\\r\\n    }\\r\\n\\r\\n    h2 {\\r\\n        font-size: 60px;\\r\\n    }\\r\\n\\r\\n    h1 {\\r\\n        letter-spacing: 12px;\\r\\n        word-spacing: 2px;\\r\\n    }\\r\\n\\r\\n    .about_me {\\r\\n        width: 90%;\\r\\n        padding: 20px 0;\\r\\n        display: flex;\\r\\n        flex-direction: column;\\r\\n        gap: 10px;\\r\\n    }\\r\\n\\r\\n    .going_down {\\r\\n        width: 100%;\\r\\n        position: absolute;\\r\\n        bottom: 20px;\\r\\n        display: flex;\\r\\n        justify-content: center;\\r\\n    }\\r\\n\\r\\n    .going_down a {\\r\\n        width: fit-content;\\r\\n        display: flex;\\r\\n        flex-direction: column;\\r\\n        align-items: center;\\r\\n    }\\r\\n\\r\\n    .going_down svg {\\r\\n        font-size: 30px;\\r\\n        margin-top: -20px;\\r\\n        transform: scaleX(1.2);\\r\\n        opacity: 0.8;\\r\\n    }\\r\\n\\r\\n    .buttons {\\r\\n        display: flex;\\r\\n        align-items: center;\\r\\n        gap: 20px;\\r\\n    }\\r\\n\\r\\n    .buttons button {\\r\\n        background: var(--pry-color);\\r\\n        border: 2px solid var(--pry-color);\\r\\n        border-radius: 8px;\\r\\n        padding: 10px 15px;\\r\\n    }\\r\\n\\r\\n    .buttons a {\\r\\n        color: var(--pry-color);\\r\\n        border: 2px solid var(--pry-color);\\r\\n        border-radius: 8px;\\r\\n        padding: 10px 15px;\\r\\n        font-size: 14px;\\r\\n    }\\r\\n</style>"],"names":[],"mappings":"AAoCI,8CAAiB,CACb,UAAU,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,CAAC,CAC9B,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,QAAQ,CAAE,QACd,CAEA,gCAAE,CAAE,gCAAE,CAAE,gCAAG,CACP,WAAW,CAAE,CAAC,CACd,UAAU,CAAE,IAChB,CAEA,gCAAG,CACC,SAAS,CAAE,IACf,CAEA,gCAAG,CACC,cAAc,CAAE,IAAI,CACpB,YAAY,CAAE,GAClB,CAEA,uCAAU,CACN,KAAK,CAAE,GAAG,CACV,OAAO,CAAE,IAAI,CAAC,CAAC,CACf,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,GAAG,CAAE,IACT,CAEA,yCAAY,CACR,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MACrB,CAEA,0BAAW,CAAC,gBAAE,CACV,KAAK,CAAE,WAAW,CAClB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MACjB,CAEA,0BAAW,CAAC,kBAAI,CACZ,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,KAAK,CACjB,SAAS,CAAE,OAAO,GAAG,CAAC,CACtB,OAAO,CAAE,GACb,CAEA,sCAAS,CACL,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,IACT,CAEA,uBAAQ,CAAC,qBAAO,CACZ,UAAU,CAAE,IAAI,WAAW,CAAC,CAC5B,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,WAAW,CAAC,CAClC,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,IAAI,CAAC,IAClB,CAEA,uBAAQ,CAAC,gBAAE,CACP,KAAK,CAAE,IAAI,WAAW,CAAC,CACvB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,WAAW,CAAC,CAClC,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,SAAS,CAAE,IACf"}`
};
const Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_language();
  $$unsubscribe_dataLang();
  return `<section class="section_wrapper svelte-13bqemh" id="about"><h3 class="svelte-13bqemh">${escape($dataLang.hero.h3)}</h3> <h2 class="svelte-13bqemh">${escape($dataLang.hero.h2)}</h2> <h1 class="svelte-13bqemh">${escape($dataLang.hero.h1)}</h1> <div class="about_me svelte-13bqemh"><p>${escape($dataLang.hero.paragraph[0])}</p> <p>${escape($dataLang.hero.paragraph[1])}</p> <p>${escape($dataLang.hero.paragraph[2])}</p> <p>${escape($dataLang.hero.paragraph[3])}</p></div> <div class="going_down svelte-13bqemh" data-svelte-h="svelte-aslpq4"><a href="#skills" class="svelte-13bqemh"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="svelte-13bqemh"><path fill="currentColor" fill-rule="evenodd" d="m6 7l6 6l6-6l2 2l-8 8l-8-8z"></path></svg> <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="svelte-13bqemh"><path fill="currentColor" fill-rule="evenodd" d="m6 7l6 6l6-6l2 2l-8 8l-8-8z"></path></svg></a></div> <div class="buttons svelte-13bqemh"><button class="svelte-13bqemh">${escape($dataLang.hero.buttons[0])}</button> <a href="#contact" class="svelte-13bqemh">${escape($dataLang.hero.buttons[1])}</a></div> </section>`;
});
