...
const css$3 = {
  code: `header.svelte-93nxko.svelte-93nxko{width:100%;position:sticky;top:0;z-index:9999;background:var(--background-color);filter:drop-shadow(0 4px 4px #0004)}nav.svelte-93nxko.svelte-93nxko{width:100%;max-width:1100px;margin:0 auto;padding:10px 20px;background:var(--background-color);display:flex;align-items:center;gap:20px;position:relative}.switch.svelte-93nxko.svelte-93nxko{--secondary-container:#d6d6d6;--primary:rgb(143, 143, 143);font-size:12px;position:relative;display:inline-block;width:3.7em;height:1.8em;margin-right:auto}.switch.svelte-93nxko input.svelte-93nxko{display:none;opacity:0;width:0;height:0}.slider.svelte-93nxko.svelte-93nxko{position:absolute;cursor:pointer;top:0;left:0;right:0;bottom:0;background-color:#313033;transition:.2s;border-radius:30px}.slider.svelte-93nxko.svelte-93nxko:before{position:absolute;content:"";height:1.4em;width:1.4em;border-radius:20px;left:0.2em;bottom:0.2em;background-color:#aeaaae;transition:.4s}body.light input:checked+.slider.svelte-93nxko.svelte-93nxko::before{background-color:var(--primary)}body.light input:checked+.slider.svelte-93nxko.svelte-93nxko{background-color:var(--secondary-container)}input.svelte-93nxko:focus+.slider.svelte-93nxko{box-shadow:0 0 1px var(--secondary-container)}input.svelte-93nxko:checked+.slider.svelte-93nxko:before{transform:translateX(1.9em)}.burger.svelte-93nxko.svelte-93nxko{font-size:20px;cursor:pointer;display:block}ul.svelte-93nxko.svelte-93nxko{width:100%;display:flex;flex-direction:column;align-items:center;background:var(--background-color);position:absolute;top:-650px;transition:0.4s;z-index:-1}ul.active.svelte-93nxko.svelte-93nxko{top:50px}li.svelte-93nxko.svelte-93nxko{width:fit-content;height:40px;display:flex;align-items:center;overflow:hidden}a.svelte-93nxko.svelte-93nxko{position:relative}a.svelte-93nxko.svelte-93nxko::before{content:'';width:100%;height:2px;position:absolute;bottom:-2px;left:-90%;background-color:rgba(var(--pry-color-rgb), 0.4);transition:0.8s}a.svelte-93nxko.svelte-93nxko:hover::before{left:90%}a.active.svelte-93nxko.svelte-93nxko::before{left:0%;transition:0.2;background-color:rgba(var(--pry-color-rgb), 1)}.languages.svelte-93nxko.svelte-93nxko{display:flex;gap:10px}button.svelte-93nxko.svelte-93nxko{padding:0 4px;font-size:30px;border:none;background-color:transparent;display:flex;align-items:center}button.active.svelte-93nxko.svelte-93nxko{outline:2px solid rgba(var(--pry-color-rgb), 0.4);border-radius:8px}@media(min-width: 700px){.burger.svelte-93nxko.svelte-93nxko{display:none}ul.svelte-93nxko.svelte-93nxko{width:fit-content;flex-direction:row;gap:20px;position:initial;top:50px;right:0;z-index:0}}`,
  map: `{"version":3,"file":"Header.svelte","sources":["Header.svelte"],"sourcesContent":["<script>\\r\\n    import Icon from \\"@iconify/svelte\\";\\r\\n    import { page } from \\"$app/stores\\";\\r\\n    import { language, dataLang, themeColor } from '../store/store'\\r\\n    import { data } from '$lib/data.js';\\r\\n    import { browser } from \\"$app/environment\\";\\r\\n    // import { onMount } from 'svelte'\\r\\n\\r\\n    let idioma = 'es'\\r\\n    let themeColorStorage = 'dark'\\r\\n\\r\\n    let openMenu = false\\r\\n\\r\\n    $: $language = idioma\\r\\n    $: $dataLang = data.find((item) => item.lang === $language).data;\\r\\n    \\r\\n    const handleLang = (lang) => {\\r\\n        idioma = lang\\r\\n    }\\r\\n    \\r\\n    const handleTheme = (e) => {\\r\\n        e.target.checked ? $themeColor = 'light' : $themeColor = 'dark'\\r\\n        \\r\\n        let body = document.querySelector('body')\\r\\n\\r\\n        body.setAttribute('class', $themeColor)\\r\\n    }\\r\\n\\r\\n    if (browser) {\\r\\n        idioma = window.localStorage.getItem(\\"languageSite\\") || \\"es\\";\\r\\n        themeColorStorage = window.localStorage.getItem(\\"themeSite\\") || \\"dark\\";\\r\\n        handleLang(idioma)\\r\\n\\r\\n        let body = document.querySelector('body')\\r\\n\\r\\n        body.setAttribute('class', \`\${themeColorStorage}\`)\\r\\n    }\\r\\n\\r\\n    $: if (browser) {\\r\\n        window.localStorage.setItem(\\"languageSite\\", $language);\\r\\n        window.localStorage.setItem(\\"themeSite\\", $themeColor);\\r\\n    }\\r\\n    \\r\\n    $: liActive = $page.url.hash.substring(1) || 'about';\\r\\n\\r\\n    export const handleLi = (listItem) => {\\r\\n        liActive = listItem\\r\\n    }\\r\\n    \\r\\n    // onMount(() => {\\r\\n    //     let body = document.querySelector('body')\\r\\n    //     body.addEventListener('click', (e) => closeMenu(e))\\r\\n    // })\\r\\n    \\r\\n    // const closeMenu = (e) => {\\r\\n    //     console.log(e)\\r\\n    // }\\r\\n<\/script>\\r\\n\\r\\n<header>\\r\\n    <nav>\\r\\n        <div class=\\"languages\\">\\r\\n            <button on:click={ () => handleLang('en') } class={ idioma === 'en' ? 'active' : '' }>\\r\\n                <Icon icon=\\"twemoji:flag-united-states\\" />\\r\\n            </button>\\r\\n            <button on:click={ () => handleLang('es') } class={ idioma === 'es' ? 'active' : '' }>\\r\\n                <Icon icon=\\"twemoji:flag-argentina\\" />\\r\\n            </button>\\r\\n        </div>\\r\\n\\r\\n        <label class=\\"switch\\">\\r\\n            <input type=\\"checkbox\\" on:change={(e) => handleTheme(e)}>\\r\\n            <span class=\\"slider\\"></span>\\r\\n        </label>\\r\\n    \\r\\n        <ul class={ openMenu ? 'active' : '' }>\\r\\n            <li>\\r\\n                <a on:click={ () => handleLi('about') } class={ liActive === 'about' ? 'active' : '' } href=\\"#about\\">\\r\\n                    {$dataLang.header[0]}\\r\\n                </a>\\r\\n            </li>\\r\\n            <li>\\r\\n                <a on:click={ () => handleLi('skills') } class={ liActive === 'skills' ? 'active' : '' } href=\\"#skills\\">\\r\\n                    {$dataLang.header[1]}\\r\\n                </a>\\r\\n            </li>\\r\\n            <li>\\r\\n                <a on:click={ () => handleLi('projects') } class={ liActive === 'projects' ? 'active' : '' } href=\\"#projects\\">\\r\\n                    {$dataLang.header[2]}\\r\\n                </a>\\r\\n            </li>\\r\\n            <li>\\r\\n                <a on:click={ () => handleLi('experience') } class={ liActive === 'experience' ? 'active' : '' } href=\\"#experience\\">\\r\\n                    {$dataLang.header[3]}\\r\\n                </a>\\r\\n            </li>\\r\\n            <li>\\r\\n                <a on:click={ () => handleLi('contact') } class={ liActive === 'contact' ? 'active' : '' } href=\\"#contact\\">\\r\\n                    {$dataLang.header[4]}\\r\\n                </a>\\r\\n            </li>\\r\\n        </ul>\\r\\n\\r\\n        <!-- svelte-ignore a11y-click-events-have-key-events -->\\r\\n        <!-- svelte-ignore a11y-no-static-element-interactions -->\\r\\n        <div class=\\"burger\\" on:click={ () => openMenu = !openMenu }>\\r\\n            <svg xmlns=\\"http://www.w3.org/2000/svg\\" width=\\"1em\\" height=\\"1em\\" viewBox=\\"0 0 24 24\\" {...$$props}>\\r\\n                <path fill=\\"none\\" stroke=\\"currentColor\\" stroke-linecap=\\"round\\" stroke-linejoin=\\"round\\" stroke-width=\\"2\\" d=\\"M3 6h18M3 12h18M3 18h18\\" />\\r\\n            </svg>\\r\\n        </div>\\r\\n    </nav>\\r\\n\\r\\n</header>\\r\\n\\r\\n<style>\\r\\n    header {\\r\\n        width: 100%;\\r\\n        position: sticky;\\r\\n        top: 0;\\r\\n        z-index: 9999;\\r\\n        background: var(--background-color);\\r\\n        filter: drop-shadow(0 4px 4px #0004);\\r\\n        /* overflow-y: hidden; */\\r\\n    }\\r\\n    \\r\\n    nav {\\r\\n        width: 100%;\\r\\n        max-width: 1100px;\\r\\n        margin: 0 auto;\\r\\n        padding: 10px 20px;\\r\\n        background: var(--background-color);\\r\\n        display: flex;\\r\\n        align-items: center;\\r\\n        gap: 20px;\\r\\n        position: relative;\\r\\n    }\\r\\n\\r\\n    .switch {\\r\\n        --secondary-container: #d6d6d6;\\r\\n        --primary: rgb(143, 143, 143);\\r\\n        font-size: 12px;\\r\\n        position: relative;\\r\\n        display: inline-block;\\r\\n        width: 3.7em;\\r\\n        height: 1.8em;\\r\\n        margin-right: auto;\\r\\n    }\\r\\n\\r\\n    .switch input {\\r\\n        display: none;\\r\\n        opacity: 0;\\r\\n        width: 0;\\r\\n        height: 0;\\r\\n    }\\r\\n\\r\\n    .slider {\\r\\n        position: absolute;\\r\\n        cursor: pointer;\\r\\n        top: 0;\\r\\n        left: 0;\\r\\n        right: 0;\\r\\n        bottom: 0;\\r\\n        background-color: #313033;\\r\\n        transition: .2s;\\r\\n        border-radius: 30px;\\r\\n    }\\r\\n\\r\\n    .slider:before {\\r\\n        position: absolute;\\r\\n        content: \\"\\";\\r\\n        height: 1.4em;\\r\\n        width: 1.4em;\\r\\n        border-radius: 20px;\\r\\n        left: 0.2em;\\r\\n        bottom: 0.2em;\\r\\n        background-color: #aeaaae;\\r\\n        transition: .4s;\\r\\n    }\\r\\n\\r\\n    :global(body.light) input:checked + .slider::before {\\r\\n        background-color: var(--primary);\\r\\n    }\\r\\n\\r\\n    :global(body.light) input:checked + .slider {\\r\\n        background-color: var(--secondary-container);\\r\\n    }\\r\\n\\r\\n    input:focus + .slider {\\r\\n        box-shadow: 0 0 1px var(--secondary-container);\\r\\n    }\\r\\n\\r\\n    input:checked + .slider:before {\\r\\n        transform: translateX(1.9em);\\r\\n    }\\r\\n\\r\\n    .burger {\\r\\n        font-size: 20px;\\r\\n        cursor: pointer;\\r\\n        display: block;\\r\\n    }\\r\\n\\r\\n    ul {\\r\\n        width: 100%;\\r\\n        display: flex;\\r\\n        flex-direction: column;\\r\\n        align-items: center;\\r\\n        background: var(--background-color);\\r\\n        position: absolute;\\r\\n        top: -650px;\\r\\n        /* right: -100%; */\\r\\n        transition: 0.4s;\\r\\n        z-index: -1;\\r\\n    }\\r\\n\\r\\n    ul.active {\\r\\n        top: 50px;\\r\\n    }\\r\\n\\r\\n    li {\\r\\n        width: fit-content;\\r\\n        height: 40px;\\r\\n        display: flex;\\r\\n        align-items: center;\\r\\n        overflow: hidden;\\r\\n    }\\r\\n\\r\\n    a {\\r\\n        position: relative;\\r\\n    }\\r\\n    \\r\\n    a::before {\\r\\n        content: '';\\r\\n        width: 100%;\\r\\n        height: 2px;\\r\\n        position: absolute;\\r\\n        bottom: -2px;\\r\\n        left: -90%;\\r\\n        background-color: rgba(var(--pry-color-rgb), 0.4);\\r\\n        transition: 0.8s;\\r\\n    }\\r\\n\\r\\n    a:hover::before {\\r\\n        left: 90%;\\r\\n    }\\r\\n\\r\\n    a.active::before {\\r\\n        left: 0%;\\r\\n        transition: 0.2;\\r\\n        background-color: rgba(var(--pry-color-rgb), 1);\\r\\n    }\\r\\n\\r\\n    .languages {\\r\\n        display: flex;\\r\\n        gap: 10px;\\r\\n    }\\r\\n\\r\\n    button {\\r\\n        padding: 0 4px;\\r\\n        font-size: 30px;\\r\\n        border: none;\\r\\n        background-color: transparent;\\r\\n        display: flex;\\r\\n        align-items: center;\\r\\n    }\\r\\n\\r\\n    button.active {\\r\\n        outline: 2px solid rgba(var(--pry-color-rgb), 0.4);\\r\\n        border-radius: 8px;\\r\\n    }\\r\\n\\r\\n    @media (min-width: 700px) {\\r\\n        .burger {\\r\\n            display: none;\\r\\n        }\\r\\n\\r\\n        ul {\\r\\n            width: fit-content;\\r\\n            flex-direction: row;\\r\\n            gap: 20px;\\r\\n            position: initial;\\r\\n            top: 50px;\\r\\n            right: 0;\\r\\n            z-index: 0;\\r\\n        }\\r\\n    }\\r\\n</style>"],"names":[],"mappings":"AAmHI,kCAAO,CACH,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,MAAM,CAChB,GAAG,CAAE,CAAC,CACN,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,IAAI,kBAAkB,CAAC,CACnC,MAAM,CAAE,YAAY,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAEvC,CAEA,+BAAI,CACA,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,UAAU,CAAE,IAAI,kBAAkB,CAAC,CACnC,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,IAAI,CACT,QAAQ,CAAE,QACd,CAEA,mCAAQ,CACJ,qBAAqB,CAAE,OAAO,CAC9B,SAAS,CAAE,kBAAkB,CAC7B,SAAS,CAAE,IAAI,CACf,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,YAAY,CACrB,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,CACb,YAAY,CAAE,IAClB,CAEA,qBAAO,CAAC,mBAAM,CACV,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,CAAC,CACV,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,CACZ,CAEA,mCAAQ,CACJ,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,OAAO,CACf,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,CAAC,CACT,gBAAgB,CAAE,OAAO,CACzB,UAAU,CAAE,GAAG,CACf,aAAa,CAAE,IACnB,CAEA,mCAAO,OAAQ,CACX,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,EAAE,CACX,MAAM,CAAE,KAAK,CACb,KAAK,CAAE,KAAK,CACZ,aAAa,CAAE,IAAI,CACnB,IAAI,CAAE,KAAK,CACX,MAAM,CAAE,KAAK,CACb,gBAAgB,CAAE,OAAO,CACzB,UAAU,CAAE,GAChB,CAEQ,UAAW,CAAC,KAAK,QAAQ,CAAG,mCAAO,QAAS,CAChD,gBAAgB,CAAE,IAAI,SAAS,CACnC,CAEQ,UAAW,CAAC,KAAK,QAAQ,CAAG,mCAAQ,CACxC,gBAAgB,CAAE,IAAI,qBAAqB,CAC/C,CAEA,mBAAK,MAAM,CAAG,qBAAQ,CAClB,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,qBAAqB,CACjD,CAEA,mBAAK,QAAQ,CAAG,qBAAO,OAAQ,CAC3B,SAAS,CAAE,WAAW,KAAK,CAC/B,CAEA,mCAAQ,CACJ,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,OAAO,CACf,OAAO,CAAE,KACb,CAEA,8BAAG,CACC,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,IAAI,kBAAkB,CAAC,CACnC,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,MAAM,CAEX,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,EACb,CAEA,EAAE,mCAAQ,CACN,GAAG,CAAE,IACT,CAEA,8BAAG,CACC,KAAK,CAAE,WAAW,CAClB,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,QAAQ,CAAE,MACd,CAEA,6BAAE,CACE,QAAQ,CAAE,QACd,CAEA,6BAAC,QAAS,CACN,OAAO,CAAE,EAAE,CACX,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CACX,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,IAAI,CAAE,IAAI,CACV,gBAAgB,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,GAAG,CAAC,CACjD,UAAU,CAAE,IAChB,CAEA,6BAAC,MAAM,QAAS,CACZ,IAAI,CAAE,GACV,CAEA,CAAC,mCAAO,QAAS,CACb,IAAI,CAAE,EAAE,CACR,UAAU,CAAE,GAAG,CACf,gBAAgB,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,CAClD,CAEA,sCAAW,CACP,OAAO,CAAE,IAAI,CACb,GAAG,CAAE,IACT,CAEA,kCAAO,CACH,OAAO,CAAE,CAAC,CAAC,GAAG,CACd,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,IAAI,CACZ,gBAAgB,CAAE,WAAW,CAC7B,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MACjB,CAEA,MAAM,mCAAQ,CACV,OAAO,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,GAAG,CAAC,CAClD,aAAa,CAAE,GACnB,CAEA,MAAO,YAAY,KAAK,CAAE,CACtB,mCAAQ,CACJ,OAAO,CAAE,IACb,CAEA,8BAAG,CACC,KAAK,CAAE,WAAW,CAClB,cAAc,CAAE,GAAG,CACnB,GAAG,CAAE,IAAI,CACT,QAAQ,CAAE,OAAO,CACjB,GAAG,CAAE,IAAI,CACT,KAAK,CAAE,CAAC,CACR,OAAO,CAAE,CACb,CACJ"}`
};
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_language();
  $$unsubscribe_dataLang();
  return `<header class="svelte-93nxko"><nav class="svelte-93nxko"><div class="languages svelte-93nxko"><button class="${escape(null_to_empty(""), true) + " svelte-93nxko"}">${validate_component(Icon, "Icon").$$render($$result, { icon: "twemoji:flag-united-states" }, {}, {})}</button> <button class="${escape(null_to_empty("active"), true) + " svelte-93nxko"}">${validate_component(Icon, "Icon").$$render($$result, { icon: "twemoji:flag-argentina" }, {}, {})}</button></div> <label class="switch svelte-93nxko"><input type="checkbox" class="svelte-93nxko"> <span class="slider svelte-93nxko"></span></label> <ul class="${escape(null_to_empty(""), true) + " svelte-93nxko"}"><li class="svelte-93nxko"><a class="${escape(null_to_empty(liActive === "about" ? "active" : ""), true) + " svelte-93nxko"}" href="#about">${escape($dataLang.header[0])}</a></li> <li class="svelte-93nxko"><a class="${escape(null_to_empty(liActive === "skills" ? "active" : ""), true) + " svelte-93nxko"}" href="#skills">${escape($dataLang.header[1])}</a></li> <li class="svelte-93nxko"><a class="${escape(null_to_empty(liActive === "projects" ? "active" : ""), true) + " svelte-93nxko"}" href="#projects">${escape($dataLang.header[2])}</a></li> <li class="svelte-93nxko"><a class="${escape(null_to_empty(liActive === "experience" ? "active" : ""), true) + " svelte-93nxko"}" href="#experience">${escape($dataLang.header[3])}</a></li> <li class="svelte-93nxko"><a class="${escape(null_to_empty(liActive === "contact" ? "active" : ""), true) + " svelte-93nxko"}" href="#contact">${escape($dataLang.header[4])}</a></li></ul>   <div class="burger svelte-93nxko"><svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { width: "1em" },
      { height: "1em" },
    ...
    { classes: "svelte-93nxko" }
  )}><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6h18M3 12h18M3 18h18"></path></svg></div></nav> </header>`;
});
const user = "/_app/immutable/assets/user-image-removebg.BoM4EE51.png";
const CV = "/_app/immutable/assets/CV%20Front%20End%20-%20Esteban%20Pechuan.BAH_CZjL.pdf";
const css$2 = {
  code: ".section_wrapper.svelte-d5y9sa.svelte-d5y9sa{min-height:calc(100vh - 60px);width:100%;padding-bottom:100px;display:grid;grid-template-columns:1fr;gap:40px;place-items:center;position:relative}h1.svelte-d5y9sa.svelte-d5y9sa,h2.svelte-d5y9sa.svelte-d5y9sa,h3.svelte-d5y9sa.svelte-d5y9sa{line-height:1.3;margin-top:-5px}h2.svelte-d5y9sa.svelte-d5y9sa{font-size:60px}h1.svelte-d5y9sa.svelte-d5y9sa{letter-spacing:6px;font-weight:400}.about_me.svelte-d5y9sa .div.svelte-d5y9sa{width:100%;padding:20px 0}.about_me.svelte-d5y9sa .div p.svelte-d5y9sa{margin-bottom:10px}.about_me.svelte-d5y9sa img.svelte-d5y9sa{shape-outside:url('../lib/images/user-image-removebg.png');shape-margin:0px;float:right;width:350px;filter:drop-shadow(8px -5px 0 rgba(var(--pry-color-rgb), 0.2));position:relative;top:-50px;right:-50px}.user_img.svelte-d5y9sa.svelte-d5y9sa{display:none}.going_down.svelte-d5y9sa.svelte-d5y9sa{width:100%;position:absolute;bottom:20px;display:flex;justify-content:center}.going_down.svelte-d5y9sa a.svelte-d5y9sa{width:fit-content;display:flex;flex-direction:column;align-items:center}.going_down.svelte-d5y9sa svg.svelte-d5y9sa{font-size:30px;margin-top:-20px;transform:scaleX(1.2);opacity:0.8}.buttons.svelte-d5y9sa.svelte-d5y9sa{display:flex;align-items:center;gap:20px}.buttons.svelte-d5y9sa a.svelte-d5y9sa:nth-child(1){background:var(--pry-color);border:2px solid var(--pry-color);border-radius:8px;padding:10px 15px;color:#fff\r\n    }.buttons.svelte-d5y9sa a.svelte-d5y9sa{color:var(--pry-color);border:2px solid var(--pry-color);border-radius:8px;padding:10px 15px;font-size:14px}@media(min-width: 700px){.user_img.svelte-d5y9sa.svelte-d5y9sa{display:block}}",
  map: `{"version":3,"file":"Hero.svelte","sources":["Hero.svelte"],"sourcesContent":["<script>\\r\\n    import { language, dataLang } from '../store/store'\\r\\n    import { data } from '$lib/data.js';\\r\\n    import user from '$lib/images/user-image-removebg.png'\\r\\n    import CV from '$lib/CV Front End - Esteban Pechuan.pdf'\\r\\n\\r\\n    $: $dataLang = data.find((item) => item.lang === $language).data;\\r\\n<\/script>\\r\\n\\r\\n<section class=\\"section_wrapper\\" id=\\"about\\">\\r\\n    <div class=\\"info\\">\\r\\n        <h3>{$dataLang.hero.h3}</h3>\\r\\n\\r\\n        <h2>{$dataLang.hero.h2}</h2>\\r\\n        \\r\\n        <h1>{$dataLang.hero.h1}</h1>\\r\\n\\r\\n        <div class=\\"about_me\\">\\r\\n            <div class=\\"div\\">\\r\\n                <img class=\\"user_img\\" src={user} alt=\\"\\">\\r\\n                <p>{$dataLang.hero.paragraph[0]}</p>\\r\\n                <p>{$dataLang.hero.paragraph[1]}</p>\\r\\n                <p>{$dataLang.hero.paragraph[2]}</p>\\r\\n                <p>{$dataLang.hero.paragraph[3]}</p>\\r\\n            </div>\\r\\n\\r\\n        </div>\\r\\n\\r\\n        <div class=\\"going_down\\">\\r\\n            <a href=\\"#skills\\">\\r\\n                <svg xmlns=\\"http://www.w3.org/2000/svg\\" width=\\"1em\\" height=\\"1em\\" viewBox=\\"0 0 24 24\\"><path fill=\\"currentColor\\" fill-rule=\\"evenodd\\" d=\\"m6 7l6 6l6-6l2 2l-8 8l-8-8z\\"/></svg>\\r\\n\\r\\n                <svg xmlns=\\"http://www.w3.org/2000/svg\\" width=\\"1em\\" height=\\"1em\\" viewBox=\\"0 0 24 24\\"><path fill=\\"currentColor\\" fill-rule=\\"evenodd\\" d=\\"m6 7l6 6l6-6l2 2l-8 8l-8-8z\\"/></svg>\\r\\n            </a>\\r\\n        </div>\\r\\n\\r\\n        <div class=\\"buttons\\">\\r\\n            <a href={CV} download=\\"Resume Esteban Pechuan Developer\\">{$dataLang.hero.buttons[0]}</a>\\r\\n            <a href=\\"#contact\\">{$dataLang.hero.buttons[1]}</a>\\r\\n        </div>\\r\\n    </div>\\r\\n</section>\\r\\n\\r\\n<style>\\r\\n    .section_wrapper {\\r\\n        min-height: calc(100vh - 60px);\\r\\n        width: 100%;\\r\\n        padding-bottom: 100px;\\r\\n        display: grid;\\r\\n        grid-template-columns: 1fr;\\r\\n        gap: 40px;\\r\\n        place-items: center;\\r\\n        position: relative;\\r\\n    }\\r\\n\\r\\n    h1, h2, h3 {\\r\\n        line-height: 1.3;\\r\\n        margin-top: -5px;\\r\\n    }\\r\\n\\r\\n    h2 {\\r\\n        font-size: 60px;\\r\\n    }\\r\\n\\r\\n    h1 {\\r\\n        letter-spacing: 6px;\\r\\n        font-weight: 400;\\r\\n    }\\r\\n    \\r\\n    .about_me .div {\\r\\n        width: 100%;\\r\\n        padding: 20px 0;\\r\\n    }\\r\\n\\r\\n    .about_me .div p{\\r\\n        margin-bottom: 10px;\\r\\n    }\\r\\n\\r\\n    .about_me img {\\r\\n        shape-outside: url('../lib/images/user-image-removebg.png');\\r\\n        shape-margin: 0px;\\r\\n        float: right;\\r\\n        width: 350px;\\r\\n        filter: drop-shadow(8px -5px 0 rgba(var(--pry-color-rgb), 0.2));\\r\\n        position: relative;\\r\\n        top: -50px;\\r\\n        right: -50px;\\r\\n    }\\r\\n\\r\\n    .user_img {\\r\\n        display: none;\\r\\n    }\\r\\n\\r\\n    .going_down {\\r\\n        width: 100%;\\r\\n        position: absolute;\\r\\n        bottom: 20px;\\r\\n        display: flex;\\r\\n        justify-content: center;\\r\\n    }\\r\\n\\r\\n    .going_down a {\\r\\n        width: fit-content;\\r\\n        display: flex;\\r\\n        flex-direction: column;\\r\\n        align-items: center;\\r\\n    }\\r\\n\\r\\n    .going_down svg {\\r\\n        font-size: 30px;\\r\\n        margin-top: -20px;\\r\\n        transform: scaleX(1.2);\\r\\n        opacity: 0.8;\\r\\n    }\\r\\n\\r\\n    .buttons {\\r\\n        display: flex;\\r\\n        align-items: center;\\r\\n        gap: 20px;\\r\\n    }\\r\\n\\r\\n    .buttons a:nth-child(1) {\\r\\n        background: var(--pry-color);\\r\\n        border: 2px solid var(--pry-color);\\r\\n        border-radius: 8px;\\r\\n        padding: 10px 15px;\\r\\n        color: #fff\\r\\n    }\\r\\n\\r\\n    .buttons a {\\r\\n        color: var(--pry-color);\\r\\n        border: 2px solid var(--pry-color);\\r\\n        border-radius: 8px;\\r\\n        padding: 10px 15px;\\r\\n        font-size: 14px;\\r\\n    }\\r\\n\\r\\n    @media (min-width: 700px) {   \\r\\n        .user_img {\\r\\n            display: block;\\r\\n        }\\r\\n    }\\r\\n</style>"],"names":[],"mappings":"AA4CI,4CAAiB,CACb,UAAU,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,CAAC,CAC9B,KAAK,CAAE,IAAI,CACX,cAAc,CAAE,KAAK,CACrB,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,GAAG,CAC1B,GAAG,CAAE,IAAI,CACT,WAAW,CAAE,MAAM,CACnB,QAAQ,CAAE,QACd,CAEA,8BAAE,CAAE,8BAAE,CAAE,8BAAG,CACP,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,IAChB,CAEA,8BAAG,CACC,SAAS,CAAE,IACf,CAEA,8BAAG,CACC,cAAc,CAAE,GAAG,CACnB,WAAW,CAAE,GACjB,CAEA,uBAAS,CAAC,kBAAK,CACX,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CAAC,CAClB,CAEA,uBAAS,CAAC,IAAI,CAAC,eAAC,CACZ,aAAa,CAAE,IACnB,CAEA,uBAAS,CAAC,iBAAI,CACV,aAAa,CAAE,4CAA4C,CAC3D,YAAY,CAAE,GAAG,CACjB,KAAK,CAAE,KAAK,CACZ,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,YAAY,GAAG,CAAC,IAAI,CAAC,CAAC,CAAC,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CAC/D,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,KAAK,CACV,KAAK,CAAE,KACX,CAEA,qCAAU,CACN,OAAO,CAAE,IACb,CAEA,uCAAY,CACR,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MACrB,CAEA,yBAAW,CAAC,eAAE,CACV,KAAK,CAAE,WAAW,CAClB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MACjB,CAEA,yBAAW,CAAC,iBAAI,CACZ,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,KAAK,CACjB,SAAS,CAAE,OAAO,GAAG,CAAC,CACtB,OAAO,CAAE,GACb,CAEA,oCAAS,CACL,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,IACT,CAEA,sBAAQ,CAAC,eAAC,WAAW,CAAC,CAAE,CACpB,UAAU,CAAE,IAAI,WAAW,CAAC,CAC5B,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,WAAW,CAAC,CAClC,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,KAAK,CAAE,IAAI;AACnB,IAAI,CAEA,sBAAQ,CAAC,eAAE,CACP,KAAK,CAAE,IAAI,WAAW,CAAC,CACvB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,WAAW,CAAC,CAClC,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,SAAS,CAAE,IACf,CAEA,MAAO,YAAY,KAAK,CAAE,CACtB,qCAAU,CACN,OAAO,CAAE,KACb,CACJ"}`
};
const Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_language();
  $$unsubscribe_dataLang();
  return `<section class="section_wrapper svelte-d5y9sa" id="about"><div class="info"><h3 class="svelte-d5y9sa">${escape($dataLang.hero.h3)}</h3> <h2 class="svelte-d5y9sa">${escape($dataLang.hero.h2)}</h2> <h1 class="svelte-d5y9sa">${escape($dataLang.hero.h1)}</h1> <div class="about_me svelte-d5y9sa"><div class="div svelte-d5y9sa"><img class="user_img svelte-d5y9sa"${add_attribute("src", user, 0)} alt=""> <p class="svelte-d5y9sa">${escape($dataLang.hero.paragraph[0])}</p> <p class="svelte-d5y9sa">${escape($dataLang.hero.paragraph[1])}</p> <p class="svelte-d5y9sa">${escape($dataLang.hero.paragraph[2])}</p> <p class="svelte-d5y9sa">${escape($dataLang.hero.paragraph[3])}</p></div></div> <div class="going_down svelte-d5y9sa" data-svelte-h="svelte-d460s"><a href="#skills" class="svelte-d5y9sa"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="svelte-d5y9sa"><path fill="currentColor" fill-rule="evenodd" d="m6 7l6 6l6-6l2 2l-8 8l-8-8z"></path></svg> <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="svelte-d5y9sa"><path fill="currentColor" fill-rule="evenodd" d="m6 7l6 6l6-6l2 2l-8 8l-8-8z"></path></svg></a></div> <div class="buttons svelte-d5y9sa"><a${add_attribute("href", CV, 0)} download="Resume Esteban Pechuan Developer" class="svelte-d5y9sa">${escape($dataLang.hero.buttons[0])}</a> <a href="#contact" class="svelte-d5y9sa">${escape($dataLang.hero.buttons[1])}</a></div></div> </section>`;
});
